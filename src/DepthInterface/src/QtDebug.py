# https://stackoverflow.com/questions/41176319/python-logging-output-on-both-gui-and-console

from .Device import *
from .Common import *

class DeviceInfo(QtGui.QWidget):
    ...
    def __init__(self, parent=None, device=None):
        ...
        if device is None:
            raise(Exception('DeviceInfo needs a device!'))
        ...
        #self.depth_stream_video_modes = depth_stream.get_sensor_info().videoModes
